...
var raccon = Paper.image('img/raccon.png', 0, 0, 125, 150).toDefs();
var choice01 = Paper.image('img/choiceC01.png', 0, 0, 118, 45).toDefs();
var choice02 = Paper.image('img/choiceC02.png', 0, 0, 118, 44).toDefs();
var choice03 = Paper.image('img/choiceC03.png', 0, 0, 118, 45).toDefs();
var choice04 = Paper.image('img/choiceC04.png', 0, 0, 118, 42).toDefs();
...
raccon.use().transform('t125, 125').appendTo(topArea);
...
choice01.use().transform('t34, 362').appendTo(bottomArea).click(pop02).attr({
  'cursor': 'pointer'
});
...
choice02.use().transform('t203, 363').appendTo(bottomArea).click(pop02).attr({
  'cursor': 'pointer'
});

//세번째 보기
bottomArea.rect(20, 470, 150, 100).click(pop01).attr({
  'fill': '#FCF8E7',
  'stroke': '#82C71D',
  'stroke-width': 2,
  'stroke-dasharray': '8 8',
...
choice03.use().transform('t34, 497').appendTo(bottomArea).click(pop01).attr({
  'cursor': 'pointer'
});
...
choice04.use().transform('t205, 498').appendTo(bottomArea).click(pop02).attr({
  'cursor': 'pointer'
});
