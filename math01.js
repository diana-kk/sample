...
bottomArea.text(180, 215, '6').attr({
  'font-size': 110,
  'text-anchor': 'middle'
});
...
bottomArea.text(180, 322, '3 + 1').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
bottomArea.text(180, 407, '2 + 3').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
bottomArea.text(180, 492, '3 + 3').click(pop01).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
bottomArea.text(180, 577, '4 + 3').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
