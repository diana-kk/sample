...
bottomArea.text(180, 215, '9').attr({
  'font-size': 110,
  'text-anchor': 'middle'
});
...
bottomArea.text(180, 322, '6 + 2').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
bottomArea.text(180, 407, '7 + 3').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
//세번째 보기
bottomArea.rect(40, 440, 280, 65).click(pop02).attr({
  'fill': '#F6FEF5',
  'stroke': 'skyblue',
  'stroke-width': 2,
  'stroke-dasharray': '8 8',
...
bottomArea.text(180, 492, '5 + 5').click(pop02).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
...
//네번째 보기
bottomArea.rect(40, 525, 280, 65).click(pop01).attr({
  'fill': '#F6FEF5',
  'stroke': 'skyblue',
  'stroke-width': 2,
  'stroke-dasharray': '8 8',
...
bottomArea.text(180, 577, '4 + 5').click(pop01).attr({
  'font-size': 50,
  'text-anchor': 'middle',
  'cursor': 'pointer'
});
